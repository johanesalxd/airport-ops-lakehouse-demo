...
| [`data-sharing.md`](data-sharing.md) | How the **Analytics Hub hub-and-spoke (NIO)** sharing works: curated `shr_*` views, publish/subscribe, subscriber whitelisting + approval, cost isolation, audit. | Engineers/architects sharing data across projects |
